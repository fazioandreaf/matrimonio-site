...
import { Heart, Camera, Calendar, MapPin, Clock, Users, MessageSquare, CheckCircle, ChevronDown, ChevronUp, Car, Gift, X, Check } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-100">
      <section className="relative py-20 px-4">
        <div className="max-w-4xl mx-auto text-center">
          <div className="mb-8">
            <Heart className="mx-auto h-16 w-16 text-green-600 mb-6" />
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <button
              onClick={() => {
                ...
                link.download = 'matrimonio-30-giugno-2027.ics';
                link.click();
              }}
              className="bg-white/70 backdrop-blur-sm rounded-lg p-6 shadow-lg hover:shadow-xl active:shadow-xl transition-all duration-300 hover:bg-white/80 active:bg-white/80 cursor-pointer group"
            >
              <Calendar className="h-8 w-8 text-green-600 mb-4 mx-auto group-hover:scale-110 group-active:scale-110 transition-transform" />
              <h3 className="font-playfair text-2xl font-semibold text-gray-800 mb-2">
                Data
              </h3>
              <p className="text-gray-600 group-hover:text-gray-800 group-active:text-gray-800 transition-colors">30 Giugno 2027</p>
              <p className="text-sm text-green-600 mt-2 opacity-100 md:opacity-0 md:group-hover:opacity-100 transition-opacity">
            ...
            <button
              ...
              className="bg-white/70 backdrop-blur-sm rounded-lg p-6 shadow-lg hover:shadow-xl active:shadow-xl transition-all duration-300 hover:bg-white/80 active:bg-white/80 cursor-pointer group"
            >
              <MapPin className="h-8 w-8 text-green-600 mb-4 mx-auto group-hover:scale-110 group-active:scale-110 transition-transform" />
              <h3 className="font-playfair text-2xl font-semibold text-gray-800 mb-2">
                Luogo
              </h3>
              <p className="text-gray-600 group-hover:text-gray-800 group-active:text-gray-800 transition-colors">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Link
              href="/gallery"
              className="inline-flex items-center px-8 py-4 border border-transparent text-base font-medium rounded-md text-white bg-green-600 hover:bg-green-700 transition-colors"
            >
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-12 bg-green-50 rounded-lg p-6 text-center">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p><strong>Email:</strong> matrimonio@ilboscoalberolungo.it</p>
